...
from airflow.operators.compile_operator import CompileOperator
from airflow.utils import timezone

DEFAULT_DATE = datetime(2019, 3, 25, tzinfo=timezone.utc)
END_DATE = datetime(2019, 3, 25, tzinfo=timezone.utc)
INTERVAL = timedelta(hours=12)


class CompileOperatorTestCase(unittest.TestCase):
    def test_echo_env_variables(self):
        ...
        self.dag = DAG(
            dag_id='compile_op_test', default_args={
                'owner': 'wengle',
                'retries': 100,
